												...
												<form:form modelAttribute="sampleBoard" method="post" action="/board/sample/sampleList">
													...
													<div class="col-sm-8 ">                                
														<div class="input-group input-group-sm">
															<input type="text" class="search-area" name="title" value="" id="title" placeholder="검색내용 입력">
										...
										<div class="row">
											<div class="col-sm-12">
												<table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
													<thead>
														<tr role="row">
															<th class="board_header-text" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">번호
															</th>
													...
													<tbody>
                                  						<c:forEach items="${list}" var="list" varStatus="status">
                                    						<tr>
                                      							...
                                      							<td align="center">${list.user_id}
                                      							</td>
                                      							<td align="center">${list.seq}
                                      							</td>
                                      							<td align="center">${list.recomm_cnt}
                                      							</td>
                                    						</tr>
                                  						</c:forEach>
                                					</tbody>
